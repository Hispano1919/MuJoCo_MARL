    ...
    def step(self, actions):
            ...
            for agent_name, action in actions.items():
                ...
                try:
                    ...
                    left_wheel_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_ACTUATOR, f"{agent_name}_left")
                    right_wheel_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_ACTUATOR, f"{agent_name}_right")
            ...
            for agent in self.agents:
                ...
                if distancia_minima < 0.5:
                    reward_agente -= 1.0  # Bonus por proximidad
                ...
                # Bonus combinado: Si está cerca Y va rápido, damos un extra
                if distancia_minima < 0.5 and velocidad_lineal > 0.5:
                    reward_agente += 2.0

                rewards[agent] = reward_agente
                # ------------------------------------------
